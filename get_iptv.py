        ...
        for channel in channel_list:
            ...
            if code:
                ...
                if channel_url and len(channel_url) > 0:
                    ...
                    channel['url_id'] = extract_url_channel_id(url)
...
def extract_url_channel_id(url):
    """
    ...
    for i, line in enumerate(lines):
        if line.startswith("#EXTINF") and i + 1 < len(lines):
            ...
            if match:
                ...
                channel_info["channel_id"] = extract_url_channel_id(play_url)
