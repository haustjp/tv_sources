...
def query_first_source():
    ...
    headers = {
        ...
        'Cookie': '_ga=GA1.1.699810718.1714914188; ckip1=42.225.145.51%7C222.84.192.120%7C119.142.76.36%7C139.209.39.206%7C182.113.206.54%7C125.106.86.246%7C113.101.119.145; ckip2=125.117.178.48%7C125.113.161.90%7C171.122.158.51%7C171.116.222.77%7C27.11.104.133%7C113.13.243.199%7C178.163.80.212%7C27.10.76.34; REFERER=Gameover; REFERER2=OzTbIr1aNbjcQO0O0O; REFERER1=NzDbMryaNbjcQO0O0O; _ga_8KY4MGK2FJ=GS1.1.1727963299.1.1.1727963338.0.0.0; _ga_JNMLRB3QLF=GS1.1.1727963286.6.1.1727963338.0.0.0',
...
def query_by_province(province, prev_url=None, page=None, code=None):
    ...
    tables = bs.select('div[class="ta6les"]')
...
def get_html_source(host_url):
    headers = {
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3',
        'Referer': f'http://tonkiang.us/hotellist.html?s={host_url}',
        'Cookie': '_ga=GA1.1.699810718.1714914188; ckip1=42.225.145.51%7C222.84.192.120%7C119.142.76.36%7C139.209.39.206%7C182.113.206.54%7C125.106.86.246%7C113.101.119.145; ckip2=125.117.178.48%7C125.113.161.90%7C171.122.158.51%7C171.116.222.77%7C27.11.104.133%7C113.13.243.199%7C178.163.80.212%7C27.10.76.34; REFERER=Gameover; REFERER2=OzTbIr1aNbjcQO0O0O; REFERER1=NzDbMryaNbjcQO0O0O; _ga_8KY4MGK2FJ=GS1.1.1727963299.1.1.1727963338.0.0.0; _ga_JNMLRB3QLF=GS1.1.1727963286.6.1.1727963338.0.0.0'
    }

    response = requests.get(
        f'http://tonkiang.us/allllist.php?s={host_url}&y=false', headers=headers)
